...
def model_choices(source_text: str, overrides: list[str]) -> dict[str, str]:
    ...
    choices = {
        ...
        "time_integrator": choice("time", "integrator", "unspecified"),
        "time_sts_integrator": choice("time", "sts_integrator", "none"),
        "time_sts_max_dt_ratio": choice("time", "sts_max_dt_ratio", "-1.0"),
        "time_cfl_number": choice("time", "cfl_number", "unspecified"),
