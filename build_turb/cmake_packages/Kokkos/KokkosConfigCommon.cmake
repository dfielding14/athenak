SET(Kokkos_DEVICES SERIAL;HIP)
SET(Kokkos_OPTIONS IMPL_CUDA_MALLOC_ASYNC;DEPRECATED_CODE_4;DEPRECATION_WARNINGS;AGGRESSIVE_VECTORIZATION;IMPL_REF_COUNT_BRANCH_UNLIKELY;IMPL_MDSPAN;IMPL_SKIP_COMPILER_MDSPAN;COMPLEX_ALIGN)
SET(Kokkos_TPLS LIBDL;ROCM;ROCTHRUST)
SET(Kokkos_ARCH ZEN3;VEGA90A)
SET(Kokkos_CXX_COMPILER "/opt/cray/pe/craype/2.7.33/bin/CC")
SET(Kokkos_CXX_COMPILER_ID "Clang")
SET(Kokkos_CXX_COMPILER_VERSION "18.0.0")
...
IF(Kokkos_ENABLE_HIP)
  SET(Kokkos_HIP_ARCHITECTURES gfx90a)
ENDIF()
