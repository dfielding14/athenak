"""Legacy-named two-stream-like engineering proxy; not reproduction evidence."""
...
_INPUT_DECK = 'tests/pic_two_stream_growth_publication.athinput'
...
def run(**kwargs):
    ...
    _remove_outputs('pic_two_stream_pub_np1')
    _run_case('serial', 1, 'pic_two_stream_pub_np1')
    _RESULTS['np1'] = _load_mode_series('pic_two_stream_pub_np1')

    if _athena_mpi_enabled():
        _remove_outputs('pic_two_stream_pub_np2')
        _run_case('mpi2', 2, 'pic_two_stream_pub_np2')
        _RESULTS['np2'] = _load_mode_series('pic_two_stream_pub_np2')
