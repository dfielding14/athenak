...
DECKS = {
    "uniform": (
        REPO_ROOT
        / "inputs/tests/pic_q006_paper_multispecies_oscillation_uniform_runtime_local_vl2_tsc.athinput"
    ),
    "smr": (
        REPO_ROOT
        / "inputs/tests/pic_q006_paper_multispecies_oscillation_smr_runtime_local_vl2_tsc.athinput"
    ),
    "audited_amr_runtime_local": (
        REPO_ROOT
        / "inputs/tests/"
        "pic_q006_paper_multispecies_oscillation_audited_amr_runtime_local_vl2_tsc.athinput"
    ),
}
...
def _validate_runtime_invocations(root: Path, pinned: dict[str, Any]) -> dict[str, Any]:
    ...
    decks = {
        "uniform": root / "decks/pic_q006_paper_multispecies_oscillation_uniform_runtime_local_vl2_tsc.athinput",
        "smr": root / "decks/pic_q006_paper_multispecies_oscillation_smr_runtime_local_vl2_tsc.athinput",
        "audited_amr": root / "decks/pic_q006_paper_multispecies_oscillation_audited_amr_runtime_local_vl2_tsc.athinput",
    }
    restart = (
        root
...
def _validate_retained_topology(root: Path, pinned: dict[str, Any]) -> None:
    ...
    for name, source in {
        "pic_q006_paper_multispecies_oscillation_uniform_runtime_local_vl2_tsc.athinput":
            DECKS["uniform"],
        "pic_q006_paper_multispecies_oscillation_smr_runtime_local_vl2_tsc.athinput": DECKS["smr"],
        "pic_q006_paper_multispecies_oscillation_audited_amr_runtime_local_vl2_tsc.athinput":
    ...
    allowed_files = {
        ...
        "bin/athena",
        "decks/pic_q006_paper_multispecies_oscillation_uniform_runtime_local_vl2_tsc.athinput",
        "decks/pic_q006_paper_multispecies_oscillation_smr_runtime_local_vl2_tsc.athinput",
        "decks/pic_q006_paper_multispecies_oscillation_audited_amr_runtime_local_vl2_tsc.athinput",
