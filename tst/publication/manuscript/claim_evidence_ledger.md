...
| Q019 nonlinear Bell | Source-local high-rigidity fixed-current-like foundation deck, bounded analyzer, and campaign design exist; qualifying source, matrix, pilots, registration, and evidence remain absent | May support scoped methods planning only; no nonlinear Bell production result or result figure is admissible |
...
`CLAIM-PROD-BELL-NONLINEAR-NOHALL-001`: qualify nonlinear Bell evolution for the
exact tested non-Hall AthenaK regime.
...
- A source-local Q023 high-rigidity fixed-current-like foundation deck and
  bounded analyzer define a controlled nonlinear diagnostic path while
  explicitly excluding a production saturation claim.
- A Q019 campaign-design record distinguishes approximate fixed-current plasma
  acceleration from a separately gated finite-rigidity CR-deflection or
  anisotropic-pressure branch.
- The production-readiness plan defines the required nonlinear saturation
  qualification contract.
- Existing Bell engineering or preparation evidence may support methods
  discussion but does not establish nonlinear production behavior.
...
|---|---|---|---|
| Q003/Q004/Q005 prerequisites | Required mechanics, coupling, and paper-faithful linear Bell gates close | Open | Complete the qualifying linear Bell convergence, MPI/GPU, and review matrix |
| Exact physical regime | Fiducial normalization, parameters, dimensional scope, exclusions, and artifact root frozen before qualifying output | Proposed design pending independent review and excluded pilots | Review and revise the Q019 design before registration |
| Qualifying decks | Exact deck matrix and checksums frozen | Source-local foundation only; qualifying matrix absent | Implement and review the separately named Q019 source and exact pilot matrix |
...
These claims support the methods-paper argument but do not substitute for either
central-result gate.

| Claim ID or topic | Intended manuscript role | Current admissible evidence | Required closure before result wording | Status |
|---|---|---|---|---|
| `CLAIM-PAPER-GYRO-001` | Relativistic particle-mechanics verification | Bounded analytical convergence and selected registered GPU oracle | Q-003, Q-025, Q-026; final figure/table, uncertainty, provenance, named review | `blocked_result` |
...
| `CLAIM-PAPER-BELL-LINEAR-001` | Establish the mandatory linear predecessor to nonlinear Bell | Paper-value preparation and estimator contracts; current proxy is not qualifying | Q-003, Q-004, Q-005, Q-023, Q-025, Q-026; registered 1D/2D/3D result and named review | `blocked_result` |
| `CLAIM-PAPER-OSCILLATION-001` | Demonstrate coupled behavior across uniform/SMR/AMR | Bounded local mechanics and short-horizon diagnostics | Q-004, Q-006, Q-009, Q-025, Q-026; long-horizon true-AMR matrix and review | `blocked_result` |
| `CLAIM-PAPER-CRSI-LINEAR-001` | Demonstrate true-delta-f linear CRSI capability | Initialization, static-oracle preparation, and bounded mechanics replay | Q-003, Q-004, Q-007, Q-023, Q-025, Q-026; theory comparison and registered campaign | `blocked_result` |
| `CLAIM-PAPER-CRPAI-LINEAR-001` | Demonstrate true-delta-f linear CRPAI capability | Initialization and static-oracle preparation | Q-003, Q-004, Q-007, Q-023, Q-025, Q-026; handedness review, theory comparison, registered campaign | `blocked_result` |
| `CLAIM-PAPER-CRPAI-DRIVEN-001` | Demonstrate driven expanding/compressing-box behavior | Bounded mechanics, CPAW preparation, and restart checks | Q-007, Q-008, Q-023, Q-025, Q-026; driven physical campaign and review | `blocked_result` |
...
| Bell linear dispersion figure | `CLAIM-PAPER-BELL-LINEAR-001` | Blocked | Registered qualifying matrix, analytical comparison, uncertainty, provenance, review |
...
2. Close Q003/Q004 and the campaign-specific prerequisites shared by Bell and
   shock work.
3. Close paper-faithful linear Bell Q005 before any nonlinear Bell qualifying
   campaign.
...
|---|---|---|
| Must both Bell nonlinear and Section 5.4 shock close for the target manuscript, or may one remain an explicitly blocked future result? | Requires author judgment | Decide manuscript scope; do not weaken either gate |
| What exact non-Hall Bell regime and dimensional scope should Q019 target? | Blocks Bell claim | Freeze before qualifying execution |
