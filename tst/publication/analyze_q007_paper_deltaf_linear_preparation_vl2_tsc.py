...
DECKS = {
    "crsi": REPO_ROOT / "inputs/tests/pic_q007_paper_crsi_linear_preparation_vl2_tsc.athinput",
    "crpai_prolate": (
        REPO_ROOT
        / "inputs/tests/pic_q007_paper_crpai_linear_prolate_preparation_vl2_tsc.athinput"
    ),
    "crpai_oblate": (
        REPO_ROOT
        / "inputs/tests/pic_q007_paper_crpai_linear_oblate_preparation_vl2_tsc.athinput"
    ),
}
...
def _validate_runtime_invocations(root: Path, pinned: dict[str, Any]) -> dict[str, Any]:
    ...
    cases = {
        "crsi": {
            "case": "crsi",
            "deck": deck_root / "pic_q007_paper_crsi_linear_preparation_vl2_tsc.athinput",
            "overrides": [],
            "returncode": 0,
        ...
        "crpai-prolate": {
            "case": "crpai_prolate",
            "deck": deck_root / "pic_q007_paper_crpai_linear_prolate_preparation_vl2_tsc.athinput",
            "overrides": [],
            "returncode": 0,
        ...
        "crpai-oblate": {
            "case": "crpai_oblate",
            "deck": deck_root / "pic_q007_paper_crpai_linear_oblate_preparation_vl2_tsc.athinput",
            "overrides": [],
            "returncode": 0,
            "output_cycles": range(2),
        },
...
def _validate_runtime_tree_topology(root: Path) -> None:
    ...
    expected = {
        ...
        "decks/pic_q007_paper_crpai_linear_prolate_preparation_vl2_tsc.athinput",
        "decks/pic_q007_paper_crpai_linear_oblate_preparation_vl2_tsc.athinput",
    }
    layouts = {
        "crsi": ("crsi", range(4)),
