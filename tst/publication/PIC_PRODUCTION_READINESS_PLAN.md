...
`c878dd6c` is active with mirrored policy SHA `0538da6d` and promotion SHA
`f84fc7b7`; the ledger remains unchanged at 37 records.
...
7. Preserve active successor `cbc6fb50`, clean commit
   ...
   job `4746245`. Preserve the reviewed paired gyro-v3 and unused paper-v2 parser
   policy at SHA `0538da6d` and promotion SHA `f84fc7b7`. Before each pre-submit
   manifest creation and again
   ...
   Then execute only
   `f1-clean-gyro-mpich-stderr-v3` and
