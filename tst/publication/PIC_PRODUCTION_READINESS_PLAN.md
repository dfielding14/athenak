...
paired immutable install inventory SHA `ea45cdc5` and existing-genesis
migration pass. Reviewed policy promotion remains pending.
...
7. Preserve active successor `cbc6fb50`, clean commit
   ...
   chronology; preserve freshly retested exact repaired successor `4ccde8df`,
   curated commit `6fa926a9` and paired-install inventory SHA `ea45cdc5`, then
   promote its reviewed policy. Before each v2 pre-submit
