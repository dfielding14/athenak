...
5. Preserve the curated clean source commit series, exact clean candidate
   `31be2cd6`, executable digest `bea2a418` and mirrored authorization
   promotion `3e7e8c7f`.
...
7. Preserve paired immutable successor control plane `6cbbbbd6`, the original
   genesis anchor and mirrored authorization promotion `3e7e8c7f`. Use only its
   installed runner for subsequent registered Frontier work and keep every
   reservation serialized through the audited ledger path.
