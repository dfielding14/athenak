...
4. Preserve the local independent adversarial PASS for historical successor
   ...
   failed closed on scheduler account spelling before execution. Active
   ...
   `OSError 524`. Active successor `e8e47ead` from operational commit
...
7. Preserve active successor `cbc6fb50`, clean commit
   ...
   chronology; preserve freshly retested active repaired successor `4ccde8df`,
...
9. Preserve predecessor control plane `e8e47ead`, the original
   genesis anchor, immutable recovery handoff `06392534` and mirrored active
   promotion `6d6bf1cd` as chronology. After the registered-F1 cutover, use only
