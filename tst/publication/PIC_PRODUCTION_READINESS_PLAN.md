...
generated inventory. Fresh exact-successor retest passes. Clean commit
curation, paired
install and reviewed policy promotion remain pending.
...
7. Preserve active successor `cbc6fb50`, clean commit
   ...
   curate one clean commit,
   pair-install it and promote its reviewed policy. Before each v2 pre-submit
