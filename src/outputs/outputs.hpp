...
static const char *var_choice[NOUTPUT_CHOICES] = {
  ...
  "hydro_wz",   "hydro_w2", "hydro_visc_heat",
  // MHD variables (17-38)
  ...
  // MHD derived variables (39-52)
  "mhd_jz",    "mhd_j2",     "mhd_curv",   "mhd_curv_alt", "mhd_k_jxb", "mhd_curv_perp",
  "mhd_bmag", "mhd_vA_mag",
  "mhd_divb", "mhd_theta_jb", "mhd_theta_vb", "mhd_curv_B_ratio",
  "mhd_jcon", "mhd_visc_heat",
  // useful for coarsened binary output (53-54)
  "hydro_sgs", "mhd_sgs",
  // dynamo wavenumber scales (55)
  "mhd_dynamo_ks",
  // turbulence (56)
  "turb_force",
  // radiation (57-73, 74-93)
