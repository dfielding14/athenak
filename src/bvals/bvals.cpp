...
particles::ParticlesBoundaryValues::ParticlesBoundaryValues(
  ...
  Kokkos::realloc(prtcl_rsendbuf, static_cast<int>(0.2*npart));
  Kokkos::realloc(prtcl_isendbuf, static_cast<int>(0.2*npart));
  Kokkos::realloc(prtcl_rrecvbuf, static_cast<int>(0.2*npart));
  Kokkos::realloc(prtcl_irecvbuf, static_cast<int>(0.2*npart));
