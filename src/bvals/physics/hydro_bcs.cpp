...
//! \brief Apply physical boundary conditions for all Hydro variables on the fine array at
//  faces of the MB which are at the edge of the computational domain. This is applied
//  *after* prolongation (see Hydro::Prolongate / Hydro::ApplyPhysicalBCs), so that the
...
void MeshBoundaryValues::HydroBCs(MeshBlockPack *ppack, DualArray2D<Real> u_in,
  ...
  BCHelperHydro(ppack, u_in, u0, is, ie, js, je, ks, ke, n1, n2, n3);
}

//----------------------------------------------------------------------------------------
//! \fn void BoundaryValues::HydroBCsCoarse()
//! \brief Apply physical boundary conditions for all Hydro variables on the coarse array.
...
void MeshBoundaryValues::HydroBCsCoarse(MeshBlockPack *ppack, DualArray2D<Real> u_in,
  ...
  BCHelperHydro(ppack, u_in, coarse_u0, cis, cie, cjs, cje, cks, cke, cn1, cn2, cn3);
}
