...
void Mesh::AddCoordinatesAndPhysics(
    ParameterInput *pinput, bool infer_ito_covariance_model_from_restart) {
  ...
  for (int n=0; n<nmb_packs_thisrank; ++n) {
    ...
    pmb_pack->AddPhysics(pinput, infer_ito_covariance_model_from_restart);
  }
