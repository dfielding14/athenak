...
use the 3D Clebsch stream construction in \path{scalar_mixing.cpp},
\begin{equation}
\uu=\nabla\phi_1\times\nabla\phi_2,
\end{equation}
...
\code{scalar\_mixing.cpp}. This section therefore documents
...
\path{inputs/tests/scalar_mixing_clebsch_divfree_scalar_flux.athinput}
...
\path{/lustre/orion/ast207/proj-shared/dfielding/autonomous_scalars/clebsch_1024}.
Every case uses \code{problem\_id=scalar\_mixing}, a
...
production scalar pair: \code{s\_00} is the global $x_1$ sine mode, and
\code{s\_01} is the second scalar field used by the canonical generator.
...
representative of the simulations: \code{scalar\_mixing},
...
this master note. Those older figures mixed several non-production
projection/stream cases. The production question here is narrower:
...
\path{scalar_mixing.cpp} campaign. The representative
