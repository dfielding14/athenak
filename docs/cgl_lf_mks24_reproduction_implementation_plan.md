...
forensic copy. Explicit legacy adoption, verification, documentation, and
source archival remain required before any `s19` preparation. A retained
...
authorize preparation after accepted job `4754008`; the post-F-100 docs commit,
actual archive/catalog, reconciliation, and queue/shared-root gates remain
mandatory before `s18`.
