...
rank-local retained-output sizing, but the first fresh `R16` pilot must still
measure production runtime and review the complete cadence/storage proposal.
