...
`t = 0.25` for `0.289167` node-hours. Prepare only
...
through exact `t = 0.25`; continue only with `R02/s02_rankio_t0p25_t1` from
its authenticated restart siblings.
...
`4746154`, accepted through exact `t = 0.25`. Prepare only
`R02/s02_rankio_t0p25_t1` next.
...
2. **Preserve the accepted fresh E03 R02 pilot from `t = 0`.**
   ...
   Prepare only `R02/s02_rankio_t0p25_t1`, then inspect and recost.
