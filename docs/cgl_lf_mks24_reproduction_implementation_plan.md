...
authorizes only `R02/s04_rankio_t1p5_t2` next.
...
Prepare only `R02/s04_rankio_t1p5_t2`, then inspect and recost.
...
continue only with `R02/s04_rankio_t1p5_t2` from its authenticated restart
siblings.
...
exact `t = 1.5`. Prepare only `R02/s04_rankio_t1p5_t2` next. Complete R02,
then R03--R16 sequentially, and execute R17 last.
...
2. **Preserve the accepted fresh E03 R02 pilot from `t = 0`.**
   ...
   `9689c269bf329542815a1b2b137881126964b05c`; focused tests, Sphinx
   warnings-as-errors, syntax, diff, and hardened reconciliation pass.
   Prepare only `R02/s04_rankio_t1p5_t2`, then inspect, account, reconcile,
