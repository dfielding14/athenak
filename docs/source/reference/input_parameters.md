...
## Input Block: `<eos>`
**Used by**: dynamo.cpp, turb.cpp, turb_timed_amr.cpp, twofluid.cpp

| Parameter | Type | Default | Source |
|-----------|------|---------|--------|
| `gamma` | Real | 5.0/3.0 | dynamo.cpp:L55 |
| `iso_sound_speed` | Real | 1.0 | turb.cpp:L48 |
...
| `conductivity` | Real | 0.0 | conduction.cpp |
| `conductivity_model` | string | constant or inferred legacy model | conduction.cpp |
| `conductivity_tref` | Real | 1.0 | conduction.cpp |
| `conductivity_exponent` | Real | 0.0 | conduction.cpp |
| `conductivity_floor` | Real | 0.0 | conduction.cpp |
| `conductivity_ceiling` | Real | large | conduction.cpp |
| `conductivity_integrator` | string | explicit | conduction.cpp |
| `viscosity` | Real | required when active | viscosity.cpp |
| `tdep_viscosity` | bool | false | viscosity.cpp |
| `viscosity_tref` | Real | 1.0 | viscosity.cpp |
| `viscosity_exponent` | Real | 0.0 | viscosity.cpp |
...
| `ohmic_resistivity_integrator` | string | explicit | resistivity.cpp |
...
| `rho0` | Real | 1.0 | turb_timed_amr.cpp:L75 |
