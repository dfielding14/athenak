...
CGL Landau-fluid heat flux has a separate focused regression:
...
That case exercises the protected CGL magnetic-moment stage lifecycle with
remote shearing partners. It checks capped-STS/explicit-split consistency,
both LF heat-flux channels, admissibility, decomposition independence,
`div B`, and restart continuity.
