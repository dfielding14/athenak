...
log_file="build_frontier_TRML_no_shear_$(date +%Y%m%d_%H%M%S).log"
...
# Frontier-optimized build script for AthenaK with TRML_no_shear problem
log_echo "=== Building AthenaK on Frontier with TRML_no_shear ==="
...
build_dir="${athenak_dir}/build_TRML_no_shear"
