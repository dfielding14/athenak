#!/usr/bin/env bash
# Configure and build AthenaK for the Tiegan SGS turbulence runs on Frontier.
...
# Prevent inherited interactive CCE include paths from contaminating the selected
# CCE wrapper environment.
