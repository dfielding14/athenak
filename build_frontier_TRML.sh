...
log_file="build_frontier_TRML_$(date +%Y%m%d_%H%M%S).log"
...
# Frontier-optimized build script for AthenaK with TRML problem
log_echo "=== Building AthenaK on Frontier with TRML ==="
...
build_dir="${athenak_dir}/build_TRML"
