#!/usr/bin/env bash
# Configure AthenaK for the simple_TRML problem with the Frontier toolchain and
# CMake options used by the 2026-06-26 CGL weak-scaling campaign.

set -euo pipefail

script_dir="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
build_dir="${BUILD_DIR:-${script_dir}/build-frontier-hip-cpe25.09-cce20-rocm6.4.2}"
